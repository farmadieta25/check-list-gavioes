    ...
    <div className="min-h-screen bg-gradient-to-br from-red-600 to-black flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-white">Gaviões Checklist</h2>
          <p className="mt-2 text-red-100">Sistema de Inspeção Técnica</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mt-6 text-center text-sm text-gray-600">
            ...
            <p><strong>Admin:</strong> admin@gavioes.com / 123456</p>
            <p><strong>Técnico:</strong> tecnico@gavioes.com / 123456</p>
          </div>
        </div>
      </div>
    </div>
